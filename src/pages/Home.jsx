    ...
    return(     
        <>
            ...
            <div className='containerTE'>
                ...
                <Menu titulo="BEBIDAS" img = {imagens.imgBebidas} itens={Pizzas}/>    
                <Menu titulo="VINHOS" img = {imagens.imgVinhos} itens={Pizzas}/>    
                <Menu titulo="SOBREMESAS" img = {imagens.imgSobremesas} itens={Pizzas}/>    
            </div>
        </>
    )
}
